...
#output dirs
baseDir = '/users/bsiranos/analysis/enhancer_conservation/encode_data/broad/trained_models/multitask_models/'

# info about different tasks
tasks = np.array([int(i) for i in range(32)])
